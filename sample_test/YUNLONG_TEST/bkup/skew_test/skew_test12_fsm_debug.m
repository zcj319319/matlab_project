...
spi_write(BASE_ADDR_CALIB_ALG, "0x40E", "0x01" ); %tiskew debug mode
spi_write(BASE_ADDR_CALIB_ALG, "0x3F0", "0x1"); %tiskew_on

spi_read(BASE_ADDR_CALIB_ALG, "0x3F2")

for i=0:10
    spi_write(BASE_ADDR_CALIB_ALG, "0x40F", "0x01" ); %tiskew debug mode
    spi_write(BASE_ADDR_CALIB_ALG, "0x40F", "0x02" ); %tiskew debug mode
    pause(0.1);
    spi_write(BASE_ADDR_CALIB_ALG, "0x40F", "0x03" ); %tiskew debug mode
end
